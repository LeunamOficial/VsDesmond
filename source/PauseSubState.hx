...
class PauseSubState extends MusicBeatSubstate
{
	...
	var menuItems:Array<String> = ['Continuar', 'Reiniciar Cancion', 'Salir Al Menu'];
	...
	public function new(x:Float, y:Float)
	{
		...
		pauseMusic = new FlxSound().loadEmbedded(Paths.music('Relajao'), true, true);
		pauseMusic.volume = 0;
		...
		}else if (downP)
		{
			...
			else if (leftP)
			{
				...
				if(!offsetChanged)
				{
					...
					menuItems = ['Reiniciar Cancion', 'Salir Al Menu'];
